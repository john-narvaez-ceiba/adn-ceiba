pipeline {
  ...
  stages{
    stage('Checkout') {
      ...
      checkout([
              ...
              submoduleCfg: [], 
              userRemoteConfigs: [[
                  credentialsId: 'GitHub_john.narvaez', 
  ...
  post {
    ...
    failure {
      ...
      mail (to: 'john.narvaez@ceiba.com.co',subject: "Failed Pipeline:${currentBuild.fullDisplayName}",body: "Something is wrong with ${env.BUILD_URL}")
    }
    unstable {
